package com.openlattice.mechanic.pods.legacy;
...
public class LegacyApp extends AbstractSecurableObject {
    ...
    public LegacyApp(
        ...
        checkArgument( StringUtils.isNotBlank( name ), "LegacyApp name cannot be blank." );
        this.name = name;
